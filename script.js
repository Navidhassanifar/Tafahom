document.addEventListener('DOMContentLoaded', () => {
    console.log('DOM لود شد! کد در حال اجراست...');
    ...
    if (hero) {
        ...
        console.error('بخش hero پیدا نشد!');
    }
    ...
    if (hamburger && navLinks) {
        console.log('دکمه‌ی همبرگری و لینک‌ها پیدا شدند!');
        hamburger.addEventListener('click', () => {
            console.log('دکمه‌ی همبرگری کلیک شد!');
        ...
        document.querySelectorAll('.nav-links a').forEach(link => {
            link.addEventListener('click', () => {
                console.log(`لینک ${link.textContent} کلیک شد!`);
        ...
        console.error('خطا: دکمه‌ی همبرگری یا لینک‌ها پیدا نشدند!');
    }
    ...
    buttons.forEach(btn => {
        btn.addEventListener('click', () => {
            console.log(`دکمه ${btn.textContent} کلیک شد!`);
    ...
    document.querySelectorAll('a[href^="#"]').forEach(anchor => {
        anchor.addEventListener('click', function (e) {
            e.preventDefault();
            console.log(`لینک ناوبری ${anchor.textContent} کلیک شد!`);
    ...
    if (backToTopBtn) {
        ...
        backToTopBtn.addEventListener('click', () => {
            console.log('دکمه بازگشت به بالا کلیک شد!');
    ...
    if (startBtn && modal) {
        console.log('دکمه‌ی شروع کنید و مودال پیدا شدند!');
        startBtn.addEventListener('click', () => {
            console.log('دکمه‌ی شروع کنید کلیک شد!');
            modal.style.display = 'flex';
            resultDiv.style.display = 'none';
            companyCodeError.style.display = 'none';
        });
    } else {
        console.error('خطا: دکمه‌ی شروع کنید یا مودال پیدا نشد!');
    }

    if (closeBtn) {
        closeBtn.addEventListener('click', () => {
            console.log('دکمه‌ی بستن مودال کلیک شد!');
    ...
    window.addEventListener('click', (e) => {
        if (e.target === modal) {
            console.log('پس‌زمینه مودال کلیک شد!');
            modal.style.display = 'none';
            resultDiv.style.display = 'none';
            subscriptionCard.style.display = 'none';
            paymentModal.style.display = 'none';
    ...
    if (form) {
        form.addEventListener('submit', (e) => {
            e.preventDefault();
            console.log('فرم استعلام شرکت ارسال شد!');
    ...
    if (subscribeBtn) {
        subscribeBtn.addEventListener('click', () => {
            console.log('دکمه خرید اشتراک کلیک شد!');
    ...
    if (paymentForm) {
        paymentForm.addEventListener('submit', (e) => {
            e.preventDefault();
            console.log('فرم پرداخت ارسال شد!');
    ...
    if (successMessage) {
        successMessage.addEventListener('click', (e) => {
            if (e.target.classList.contains('dashboard-btn')) {
                console.log('دکمه ورود به داشبورد کلیک شد!');
                const code = document.querySelector('.company-code')?.textContent;
                if (code) {
                    const dashboard = document.getElementById('dashboard');
                    hideAllSections(dashboard);
    ...
    if (closePaymentBtn) {
        closePaymentBtn.addEventListener('click', () => {
            console.log('دکمه بستن درگاه پرداخت کلیک شد!');
            paymentModal.style.display = 'none';
            loading.style.display = 'none';
            cardNumberError.style.display = 'none';
            expiryDateError.style.display = 'none';
    ...
    if (backBtn) {
        backBtn.addEventListener('click', () => {
            console.log('دکمه بازگشت درگاه پرداخت کلیک شد!');
            paymentModal.style.display = 'none';
            subscriptionCard.style.display = 'block';
            loading.style.display = 'none';
            cardNumberError.style.display = 'none';
        ...
        try {
            ...
            if (renewBtn) {
                renewBtn.addEventListener('click', () => {
                    console.log('دکمه تمدید اشتراک کلیک شد!');
                    const tier = document.querySelector('.company-tier').textContent;
                    let price;
                    switch (tier) {
                        case 'Tier 1':
    ...
    function addCollaborationEventListeners() {
        document.querySelectorAll('.details-btn').forEach(btn => {
            btn.addEventListener('click', () => {
                console.log('دکمه جزئیات همکاری کلیک شد!');
        ...
        document.querySelectorAll('.cancel-btn').forEach(btn => {
            btn.addEventListener('click', () => {
                console.log('دکمه لغو همکاری کلیک شد!');
                const collabId = btn.getAttribute('data-id');
                const code = document.querySelector('.company-code')?.textContent;
        ...
        document.querySelectorAll('.activate-btn').forEach(btn => {
            btn.addEventListener('click', () => {
                console.log('دکمه فعال کردن همکاری کلیک شد!');
                const collabId = btn.getAttribute('data-id');
                const code = document.querySelector('.company-code')?.textContent;
                let collaborationData = JSON.parse(localStorage.getItem('collaborations_' + code)) || [];
                const collabIndex = collaborationData.findIndex(c => c.id == collabId);
        ...
        if (collaborationCloseBtn) {
            collaborationCloseBtn.addEventListener('click', () => {
                console.log('دکمه بستن مودال همکاری کلیک شد!');
        ...
        window.addEventListener('click', (e) => {
            if (e.target === collaborationModal) {
                console.log('پس‌زمینه مودال همکاری کلیک شد!');
