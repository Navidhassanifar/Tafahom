document.addEventListener('DOMContentLoaded', () => {
    ...
    successMessage.addEventListener('click', (e) => {
        if (e.target.classList.contains('dashboard-btn')) {
            ...
            if (code) {
                ...
                document.getElementById('dashboard').scrollIntoView({ behavior: 'smooth' });
                successMessage.style.display = 'none'; // مخفی کردن پیام موفقیت بعد از ورود
            }
        }
    });
    ...
    function loadDashboard(code) {
        ...
        document.getElementById('welcome-message').textContent = `خوش آمدید، ${companyData.name || 'کاربر'}!`;
